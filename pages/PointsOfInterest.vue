<template>
  <div class="points-of-interest">
    ...
    <PointOfIntCard v-for="(card, index) in cards" :key="index" :card="card" />
  </div>
</template>

<script>
import PointOfIntCard from '../components/PointOfIntCard.vue'
    ...
    return {
      cards: [
        ...
        },
        {
          ...
          image: 'littlefingers-brothel.webp',
        },
        {
